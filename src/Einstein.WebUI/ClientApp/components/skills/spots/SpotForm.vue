...
<script>
  ...
  import { mapRingsActions, mapRingsFields, mapRingsMultiRowFields } from '../../skills/rings/store';
  import { mapSectorsActions, mapSectorsFields, mapSectorsMultiRowFields } from '../../skills/sectors/store';
