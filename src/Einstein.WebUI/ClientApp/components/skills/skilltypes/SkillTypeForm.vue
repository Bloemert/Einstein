  ...
  export default {
    ...
    data() {
      return {
        ...
        searchSkillTypeterText: '',
        filteredSkillTypeters: [],
    ...
    computed: {
      ...
      selected: {
        get: function() {
          return this.skilltypes[this.selectedSeqno];
        },

        set: function (skilltype) {
          this.skilltypes[this.selectedSeqno] = skilltype;
        }
      },
