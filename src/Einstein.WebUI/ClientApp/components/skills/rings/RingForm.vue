...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      selected: {
        get: function() {
          return this.rings[this.selectedSeqno];
        },

        set: function (ring) {
          this.rings[this.selectedSeqno] = ring;
        }
      },
    },
    ...
    validations: {
      ...
      form: ['selected.name', 'selected.description'],
    }
  }
</script>
